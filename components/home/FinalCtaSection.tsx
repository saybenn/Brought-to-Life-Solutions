      ...
      <div className="mx-auto max-w-10/12 px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-sm leading-relaxed text-white/80 sm:text-base">
            ...
            we&apos;ll spend 30 minutes looking at how your current site (or
            lack of one) helps or hurts that. No pitch deck, no fluff—just
            clarity on what would actually move the needle.
          </p>
          ...
          <ul className="mt-6 space-y-2 text-sm leading-relaxed text-white/80">
            ...
            <li>
              • A sense of whether BTLS is the right fit—or if you&apos;re
